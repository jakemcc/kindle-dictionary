...
(def dune-words
  [{:entry "Aba" :definition "A loose, usually black robe worn by Fremen women and Bene Gesserit sisters."}
   ...
   {:entry "Ajidamal" :definition "Disastrously-flawed synthetic melange created by the Tleilaxu Project Amal before the process of producing spice in axlotl tanks is perfected. (Also called Amal)"}
   {:entry "Amal" :definition "Disastrously-flawed synthetic melange created by the Tleilaxu Project Amal before the process of producing spice in axlotl tanks is perfected. (also called Ajidamal)"}
   ...
   {:entry "Amtal" :definition "Common rule on primitive worlds under which something is tested to determine its limits or defects. Commonly: testing to destruction."}
   {:entry "Amtal rule" :definition "Common rule on primitive worlds under which something is tested to determine its limits or defects. Commonly: testing to destruction."}
   ...
   {:entry "Baliset" :definition "Nine-stringed musical instrument, lineal descendant of the zithra, tuned to the Chusuk scale and played by strumming. Favorite instrument of Imperial troubadours."}
   ...
   {:entry "Bene Tleilax" :definition "Secretive and powerful patriarchal race known for their genetic manipulation technologies. (Also called Tleilaxu)"}
   ...
   {:entry "Harvester" :definition "Large (often 120 metres by 40 metres) spice mining machine.  (also Harvester Factory or Crawler)"}
   {:entry "Crawler" :definition "Large (often 120 metres by 40 metres) spice mining machine.  (also Harvester Factory or Harvester)"}
   {:entry "Harvester Factory" :definition "Large (often 120 metres by 40 metres) spice mining machine. (also Harvester or Crawler)"}
   ...
   {:entry "Ornithopter" :definition "Aircraft capable of sustained wing-beat flight in the manner of birds. (Shortened as 'Thopter)"}
   ...
   {:entry "Plaz" :definition "Synthetic glass, used for windows (especially in aircraft and spaceships) due to its superior strength. (also called windowplaz)"}
   ...
   {:entry "Semuta" :definition "Second narcotic derivative (by crystal extraction) from the burned residue of elacca wood. The effect (described as timeless, sustained ecstasy) is elicited by certain atonal vibrations referred to as semuta music."}
   ...
   {:entry "Sietch orgy" :definition "Fremen ritual of unrestrained sexual indulgence which takes place after a Reverend Mother shares the changed Water of Life with her community.  (also called sietch tau orgy)"}
   {:entry "Sietch tau orgy" :definition "Fremen ritual of unrestrained sexual indulgence which takes place after a Reverend Mother shares the changed Water of Life with her community. (also called Sietch orgy)"}
   ...
   {:entry "Tachyon net" :definition "Technology (involving faster-than-light tachyon particles) used by Daniel and Marty in their attempt to track and capture the no-ship Ithaca. (also called 'tachyon web')"}
   {:entry "Tachyon web" :definition "Technology (involving faster-than-light tachyon particles) used by Daniel and Marty in their attempt to track and capture the no-ship Ithaca. (also called 'tachyon net')"}
   ...
   {:entry "Thopter" :definition "Aircraft capable of sustained wing-beat flight in the manner of birds."}
   ...
   {:entry "Tleilaxu " :definition "Secretive and powerful patriarchal race known for their genetic manipulation technologies. (also Bene Tleilax)"}
   ...
   {:entry "Windowplaz " :definition "Synthetic glass, used for windows (especially in aircraft and spaceships) due to its superior strength. (also called simply plaz)"}
...
(def dune-dictionary
  {:title "Dune Dictionary"
   ...
   :copyright "Content adapted from Wikipedia under their Creative Commons Attribution-ShareAlike 3.0 Unported License."})
